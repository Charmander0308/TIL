...
public class MyAspect {
	...
	// 포인트컷 : 여러개의 조인 포인트 들 중 내가 들어갈 곳을 결정하는 조건 (서울15반 이수지 관찰력 good)
	...
	// 메서드명은 상관 없음: 직관적으로 보여주려고
	// 핵심 기능 실행 전
//	@Before("mypt()")
	public void before() {
		System.out.println("컴퓨터를 부팅한다/커피를 한잔 내린다.");
	}
...
//		System.out.println("컴퓨터를 부팅한다/커피를 한잔한다.");
		this.before();
		// 핵심관심사항 동작할래
		try {
